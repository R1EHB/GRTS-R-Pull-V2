...
Date of last mod: 25 April 2025
...
class CustomHttpAdapter (requests.adapters.HTTPAdapter):
    ...
    def init_poolmanager(self, connections, maxsize, block=False):
        retries = Retry(total=0,connect=0, read=0, redirect=0, backoff_factor=3,
...
G_INPUT_HUC12_FILE = '../../HUC-it/HUC-Data-Lists/test_HUCs.csv'
