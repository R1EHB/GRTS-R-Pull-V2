...
for (i in 2:vec_len) {
  ...
  hasMore <-
    GRTSInfo4HUC$hasMore # Are more top-level records for this HUC?
  ...
  ProjsInHUC.OuterList <-
    HUCsDetails[[1]] # One or more projects per HUC (in this URL fetch)
  ...
  # test to see if j is > 1.  Only do this loop if j > 1
  # also need to test the edge case of j=0
